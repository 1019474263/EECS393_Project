...
public class WolfPieceTester{
  ...
  public void testIsLegalNonCaptureMove(){
    ...
    JunglePiece a = new WolfPiece(test,Color.RED, "R", Jungle.Side.NORTH,null);
    test.addPiece(a,2,2);
    
    test.addPiece(new WolfPiece(test, Color.WHITE, "R",Jungle.Side.SOUTH,null),2,1);
    assertFalse(a.isLegalNonCaptureMove(2,1));/*test 0*/
    test.addPiece(new WolfPiece(test, Color.WHITE, "R",Jungle.Side.SOUTH,null),2,3);
    assertTrue(a.isLegalNonCaptureMove(2,1));/*test 1*/
    test.addPiece(new WolfPiece(test, Color.WHITE, "R", Jungle.Side.SOUTH,null),2,4);
